...
```bash
python $CLAWD_WORKSPACE/skills/telegram-assistant/scripts/save_draft.py <chat_id> "<message>" [reply_to_message_id]
```
...
```bash
python $CLAWD_WORKSPACE/skills/telegram-assistant/scripts/summarize_chat.py <chat_id> [limit] [query]
```
...
```bash
python $CLAWD_WORKSPACE/skills/telegram-assistant/scripts/search_messages.py <chat_id> <query> [limit]
```
...
```bash
python $CLAWD_WORKSPACE/skills/telegram-assistant/scripts/extract_style.py <chat_id> [sample_size]
```
