...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, OpenClawConfig, OpenClawPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramAgentReactionApprovalConfig, TelegramNetworkConfig, TelegramReactionApprovalConfig } from "openclaw/plugin-sdk/telegram-core";',
